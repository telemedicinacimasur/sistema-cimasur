...
import { OpportunityWorkflow, OpportunityRule } from '../services/automation/definitions';

// Mock DB
let db: any = {
    'automation_workflows': [OpportunityWorkflow],
    'automation_rules': [OpportunityRule],
    'workflow_executions': [],
    'automation_jobs': [],
    'automation_history': [],
...
async function runTest() {
    console.log('--- Starting Opportunity Test ---');
    ...
    const clientId = 'client_222';
    
    // 1. Trigger Event
    console.log('Step 1: Triggering crm_opportunity_created');
    await core.triggerEvent('crm_opportunity_created', { id: clientId }, 'system');
