...
export const Expediente: React.FC<ExpedienteProps> = ({
  ...
  return (
    <div className="bg-[#0D1527] min-h-screen lg:min-h-[800px] rounded-3xl shadow-2xl overflow-hidden animate-in slide-in-from-right-8 duration-700 border border-[#1E293B] flex flex-col">
      {/* 360° Header Summary */}
      <div className="bg-[#001736] text-white overflow-hidden relative">
        ...
        <div className="p-8 lg:p-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full lg:w-auto">
             <div className="bg-[#1E293B]/30 backdrop-blur-md p-4 rounded-2xl border border-[#1E293B]">
      ...
      <div className="border-b border-[#1E293B] bg-[#152035] px-8 flex overflow-x-auto gap-8 justify-start custom-scrollbar shrink-0">
        {tabs.map(tab => (
          <button
            key={tab}
      ...
      <div className="flex-1 overflow-hidden bg-[#0D1527] relative custom-scrollbar">
        <div className="p-8 pb-32 h-full overflow-y-auto w-full max-w-7xl mx-auto space-y-8">
          {activeTab === 'Información General' && (
            <>
              {/* Quick Metrics Bar */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="flex items-center gap-4 p-5 bg-[#152035] rounded-3xl border border-[#1E293B] shadow-sm hover:shadow-md transition-shadow">
                   <div className="p-3 bg-[#0D1527] rounded-2xl text-blue-600"><CreditCard className="w-5 h-5" /></div>
                   <div>
                ...
                <div className="flex items-center gap-4 p-5 bg-[#152035] rounded-3xl border border-[#1E293B] shadow-sm hover:shadow-md transition-shadow">
                   <div className="p-3 bg-[#0D1527] rounded-2xl text-emerald-600"><Activity className="w-5 h-5" /></div>
                   <div>
                ...
                <div className="flex items-center gap-4 p-5 bg-[#152035] rounded-3xl border border-[#1E293B] shadow-sm hover:shadow-md transition-shadow">
                   <div className="p-3 bg-[#0D1527] rounded-2xl text-amber-600"><Calendar className="w-5 h-5" /></div>
                   <div>
              ...
              <div className="bg-[#152035] rounded-[2.5rem] border border-[#1E293B] shadow-xl overflow-hidden relative group">
                <div className="absolute top-0 left-0 w-1.5 h-full bg-blue-600" />
                <div className="p-8 space-y-8">
                   <div className="flex justify-between items-center bg-[#0D1527] p-4 rounded-2xl">
                      <div>
                      ...
                      <div className="space-y-6">
                         {selectedClient.historialUnificado.split('\n\n').reverse().map((entry: string, idx: number) => (
                           <div key={idx} className="relative pl-8 group">
                              ...
                              <div className="bg-[#1E293B]/30 hover:bg-[#1E293B]/80 p-5 rounded-2xl border border-[#1E293B]/50 transition-all text-white/90 text-sm leading-relaxed whitespace-pre-wrap font-medium font-sans">
                                 {entry}
                              </div>
                           </div>
                         ))}
          ...
          {activeTab === 'Interacciones' && (
             <div className="max-w-3xl mx-auto space-y-8">
               <div className="bg-[#152035] p-8 rounded-[2.5rem] shadow-xl border border-[#1E293B] space-y-8">
                  <div className="space-y-2 text-center pb-6 border-b border-[#1E293B]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                     <CRMField label="Tipo de Interacción">
                       <select 
                         className="w-full border border-[#1E293B] bg-[#0D1527] p-4 rounded-2xl text-sm font-bold text-slate-700 focus:bg-[#152035] transition-all outline-none ring-2 ring-transparent focus:ring-blue-100" 
                         value={activityType}
                     ...
                     <CRMField label="Etapa de Gestión / Estado">
                        <select 
                          className="w-full border border-[#1E293B] bg-[#0D1527] p-4 rounded-2xl text-sm font-black text-blue-900 outline-none hover:bg-[#152035] transition-colors"
                  ...
                  {activityType === 'Otro' && (
                     <CRMField label="Especificar otro tipo">
                        <input className="w-full border border-[#1E293B] p-4 rounded-xl text-sm" placeholder="Mencionar el tipo de interacción" />
                     </CRMField>
                  )}
                  <CRMField label="Detalles del Suceso (Obligatorio)">
                    <textarea 
                      className="w-full h-48 p-4 border border-[#1E293B] rounded-2xl bg-[#0D1527] focus:bg-[#152035] text-sm font-medium transition-all outline-none resize-none ring-2 ring-transparent focus:ring-blue-100 leading-relaxed shadow-inner" 
                      value={newHistory}
             ...
             <div className="max-w-4xl mx-auto py-12">
                <div className="p-10 bg-slate-900 rounded-[3rem] text-white relative overflow-hidden shadow-2xl">
                   ...
                   <div className="relative z-10 space-y-8">
                      ...
                      <div className="bg-[#1E293B]/30 backdrop-blur-md border border-[#1E293B] rounded-3xl p-8 space-y-6">
          ...
          {['Capacitaciones', 'Pagos', 'Documentos', 'Comercial', 'Seguimiento', 'Automatizaciones'].includes(activeTab) && (
            <div className="flex flex-col items-center justify-center p-20 bg-[#152035] rounded-3xl border border-[#1E293B] shadow-sm border-dashed">
