...
import { TrendingUp, Users, AlertTriangle, ArrowUpCircle, ArrowDownCircle, Bell } from 'lucide-react';
      ...
      <div className="bg-[#0D1527] p-6 rounded-2xl border border-[#1E293B]">
        ...
        <div className="space-y-3">
           <div className="flex items-center justify-between p-4 bg-red-500/5 border border-red-500/20 rounded-xl">
             ...
             <button className="text-xs bg-red-500 text-white px-3 py-1 rounded-lg font-bold hover:bg-red-600">Actuar</button>
           </div>
           <div className="flex items-center justify-between p-4 bg-sky-500/5 border border-sky-500/20 rounded-xl">
             ...
             <button className="text-xs bg-sky-500 text-white px-3 py-1 rounded-lg font-bold hover:bg-sky-600">Actuar</button>
           </div>
        </div>
      </div>
    </div>
